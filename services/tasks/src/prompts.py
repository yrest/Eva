...
def build_system_prompt(registered_servers: List[Dict]) -> str:
    """
...
- search_vectors(server_id, collection, query_vector, limit=10): Search for similar vectors
...
SAFETY LEVELS:
- READ_ONLY tools (auto-approved): list_directory, read_file, search_files, embed_text, search_vectors
